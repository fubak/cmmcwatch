...
def build_header(active_page: str = "", date_str: str = None) -> str:
    ...
    <nav class="nav" id="nav" role="navigation" aria-label="Main navigation">
        ...
        <div class="nav-actions">
            ...
            <a href="https://github.com/fubak/cmmcwatch" class="nav-github" target="_blank" rel="noopener noreferrer" aria-label="View source on GitHub" title="View source on GitHub">
    ...
    <footer class="footer" role="contentinfo">
        <div class="footer-content">
            <div class="footer-main">
                ...
                {style_line}
                <a href="https://github.com/fubak/cmmcwatch" class="footer-github" target="_blank" rel="noopener noreferrer">
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-actions">
                ...
                <a href="https://github.com/fubak/cmmcwatch" class="github-btn" target="_blank" rel="noopener noreferrer">
