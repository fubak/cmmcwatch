...
COLLECTOR_SOURCES: List[SourceSpec] = [
    ...
    _rss(
        "cmmc_csis",
        "CSIS",
        "https://www.csis.org/rss/analysis/all",
        "cmmc",
        "cmmc_rss",
        tier=2,
    ),
    ...
    _rss(
        "cmmc_cyberab",
        "Cyber-AB News",
        "https://cyberab.org/feed/",
        "cmmc",
        "cmmc_rss",
        tier=2,
    ),
    SourceSpec(
        key="cmmc_federal_register",
        name="Federal Register",
        url="https://www.federalregister.gov/api/v1/documents.json",
        category="cmmc",
        kind="json",
        collector="cmmc_official",
        source_key="cmmc_federal_register",
